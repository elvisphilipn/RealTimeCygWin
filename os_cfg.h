...
* File : OS_CFG.H
* By   : Jean J. Labrosse
*        Modified for the WIN32 port and updated for uC/OS-II V2.82 by Werner Zimmermann
*	   Updated by Stejarel C. Veres for uC/OS-II V2.86
*********************************************************************************************************
*/
...
#define OS_MAX_EVENTS           128    /* Max. number of event control blocks in your application ...  */
                                       /* ... MUST be > 0 , should be >= no of mailboxes + queues + 
                                          mutexes + semaphores                                         */
...
#define OS_TASK_TMR_STK_SIZE    128    /* Timer task stack size (# of OS_STK wide entries)               */
                                       ...
                                       /* ---------------------- MISCELLANEOUS ------------------------- */
#define OS_DEBUG_EN               0    /* Enable (1) or disable (0) debug variables                      */
